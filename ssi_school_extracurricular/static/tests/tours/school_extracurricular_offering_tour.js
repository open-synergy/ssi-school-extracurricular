...
odoo.define(
    ...
    function (require) {
        ...
        tour.register(
            "ssi_school_extracurricular_school_extracurricular_offering_restart_approval",
            {
                test: true,
                url: "/web",
            },
            [
                ...
                // extracurricular "TOUR-OFFERING-RESTART-APPROVAL".
                {
                    content: "Open the record whose approval process is stalled",
                    trigger:
                        ".o_data_row:contains(TOUR-OFFERING-RESTART-APPROVAL) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    content: "Record form is open",
