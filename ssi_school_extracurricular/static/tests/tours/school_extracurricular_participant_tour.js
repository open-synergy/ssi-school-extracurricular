...
odoo.define(
    ...
    function (require) {
        ...
        tour.register(
            "ssi_school_extracurricular_school_extracurricular_participant_restart_approval",
            {
                test: true,
                url: "/web",
            },
            [
                ...
                // student "TOUR-PARTICIPANT-RESTART-APPROVAL".
                {
                    content: "Open the record whose approval process is stalled",
                    trigger:
                        ".o_data_row:contains(TOUR-PARTICIPANT-RESTART-APPROVAL) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    content: "Record form is open",
                ...
                // unless the restart actually ran (patterns-advanced-gotchas.md §P).
                {
